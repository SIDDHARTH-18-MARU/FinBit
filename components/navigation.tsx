      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          <Link href="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
            ...
            <span className="text-xl font-bold text-white">FinBit</span>
          </Link>
        ...
        {isOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 glass-dark border-t border-border">
              <button
                onClick={() => navigateToSection("features")}
                className={`block w-full text-left px-3 py-2 nav-link ${isLinkActive("features") ? "active" : ""}`}
              >
                Features
              </button>
              <button
                onClick={() => navigateToSection("pricing")}
                className={`block w-full text-left px-3 py-2 nav-link ${isLinkActive("pricing") ? "active" : ""}`}
              >
                Pricing
              </button>
              <button
                onClick={() => navigateToSection("about")}
                className={`block w-full text-left px-3 py-2 nav-link ${isLinkActive("about") ? "active" : ""}`}
              >
                About
              </button>
              <button
                onClick={() => navigateToSection("contact")}
                className={`block w-full text-left px-3 py-2 nav-link ${isLinkActive("contact") ? "active" : ""}`}
              >
                Contact
              </button>
