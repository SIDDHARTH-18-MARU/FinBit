      ...
      <div className="pt-20 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl sm:text-5xl font-bold text-balance mb-4">AI Categorization & Visualization</h1>
            <p className="text-xl text-muted-foreground text-balance max-w-3xl mx-auto">
              Smart AI automatically categorizes your expenses with 95% accuracy and provides powerful visualizations
                  ...
                  >
                    <ResponsiveContainer width="100%" height="100%">
                      <BarChart data={monthlyComparison}>
                        ...
                        <Bar dataKey="thisMonth" fill="hsl(var(--chart-1))" />
                        <Bar dataKey="lastMonth" fill="hsl(var(--chart-2))" />
                      </BarChart>
                    </ResponsiveContainer>
                  </ChartContainer>
                </CardContent>
